...
registerFont("./public/YeZiGongChangCangNanShouJi.ttf", {
  family: "YeZiGongChangCangNanShouJi",
});
registerFont("./public/NiShiYinHeDeXuanLv.ttf", {
  family: "NiShiYinHeDeXuanLv",
});
